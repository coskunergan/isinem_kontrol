...
#define configUSE_TICKLESS_IDLE  0  // tickless için bu 1 olacak
...
#define configOVERRIDE_DEFAULT_TICK_CONFIGURATION   0 // tickless için bu 1 olacak
...
#define configTOTAL_HEAP_SIZE					( ( size_t ) ( 14 * 2048 ) )
